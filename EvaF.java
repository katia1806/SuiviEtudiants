...
public class EvaF extends javax.swing.JFrame {

    /**
     * Creates new form EvaF
     */
    public EvaF() {
        initComponents();
        affbi();
    ...
    private void initComponents() {
        ...
        jLabel8.setText("Evaluation Final");
        ...
        jLabel7.setText("Selectionner un binôme :");
        ...
        jLabel3.setText("Avancement application:");
...
if(row == -1)
        {
            ...
            try {   
                ...
                String sql="SELECT * FROM evalfinal WHERE IdBinome='"+IdBinome+"'";
                rs4=stmt4.executeQuery(sql);
                while(rs4.next()){
                    t1 = String.valueOf(rs4.getInt("IdBinome"));
            ...
            if (t1 !=null){JOptionPane.showMessageDialog(null,"Il exist deja une note pour ce binome");}
            else{
                try {
                    conn=DriverManager.getConnection("jdbc:mysql://localhost/pfe?useUnicode=true&useJDBCCompliantTimezoneShift=true&useLegacyDatetimeCode=false&serverTimezone=UTC","root","");
                    stmt = conn.createStatement();
                    String sql="INSERT INTO evalfinal(EvaRapF, EvaapliF,IdBinome) VALUES ('"+avr+"', '"+ava+"', '"+IdBinome+"')";
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EvaF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
